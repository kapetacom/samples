...
/**
 * Creates a new ready NodeKeyValueClient.
 *
 * See https://github.com/kapetacom/sdk-nodejs-rest-client for more information.
 */
export async function createNodeKeyValueClient(configProvider: ConfigProvider): Promise<NodeKeyValueClient> {
    return new NodeKeyValueClient(false).$withConfigProvider(configProvider);
}
 ...
 * This happens automatically when using the ```createNodeKeyValueClient``` function or
 ...
 *
 * Recommended method is using ```createNodeKeyValueClient(configProvider:ConfigProvider)```;
 *
 * See https://github.com/kapetacom/sdk-nodejs-rest-client for more information.
 */
