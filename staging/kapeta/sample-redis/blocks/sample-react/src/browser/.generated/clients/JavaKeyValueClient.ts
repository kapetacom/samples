...
export type ConfigureJavaKeyValueClient = (client: JavaKeyValueClient) => JavaKeyValueClient;

/**
 * Creates a new JavaKeyValueClient for React components.
 ...
 */
export const useJavaKeyValueClient = (configure?: ConfigureJavaKeyValueClient): JavaKeyValueClient => {
    return useMemo(() => {
        const client = new JavaKeyValueClient();
        if (configure) {
 ...
 * Use the useJavaKeyValueClient hook to create a client in React.
 *
 * Use the JavaKeyValueClient directly in other contexts.
 */
